  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold mb-4">{editingTaskId !== null ? "Edit Task" : "Add New Task"}</h2>
      ...
      <AnimatePresence>
        {filteredTasks.map((task) => (
          ...
          >
            ...
            {expandedTaskId === task.id && <p className="mt-2 text-gray-600">{task.description}</p>}
          </motion.div>
        ))}
      </AnimatePresence>
    </div>
